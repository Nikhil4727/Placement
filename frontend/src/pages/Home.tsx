...
const Home = () => {
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-[#f2d37e] text-black py-12"> {/* Reduced height */}
  <div className="container mx-auto px-4 flex items-center justify-between">
    {/* Left Section - Text Content */}
    <div className="w-1/2 text-right">
      <h1 className="text-3xl md:text-3xl  font-bold mb-4"> {/* Reduced font size */}
        Welcome to Training & Placement Portal
      </h1>
      <p className="text-lg md:text-xl mb-6"> {/* Reduced font size */}
        Your gateway to career opportunities and professional growth
      </p>
    </div>

    {/* Right Section - Image */}
    <div className="w-1/3 flex justify-left"> {/* Reduced image width */}
      <img  src="src/pages/img-removebg-preview.png" alt="Training & Placement" className=" pt-4 w-full h-30 max-w-xs"/> {/* Smaller max width */}
    </div>
  </div>
</div>


{/* Features Section - Decreased Height */}
